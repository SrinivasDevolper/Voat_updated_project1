...
const Applications = () => {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-6 bg-white rounded-xl shadow-sm">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Complete Student Details will be visible here</p>
        </div>
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <button className="px-4 py-2 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-sm font-medium">
            Put on hold
          </button>
          <button 
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-6 bg-white rounded-xl shadow-sm">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Sorted by newest applications first</p>
        </div>
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 w-full lg:w-auto">
          <div className="relative w-full sm:w-64">
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
              value={searchTerm}
              onChange={(e) => {
          ...
          <select 
            className="w-full sm:w-auto px-4 py-2 text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
            value={statusFilter}
            onChange={(e) => {
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 border-t">
                ...
                <div className="w-full sm:w-auto">
                  <button 
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-2.5 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {filteredApplications.length > 0 && (
        <div className="mt-10 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-sm text-gray-500">
            ...
            </span> of <span className="font-medium">{filteredApplications.length}</span> applications
          </div>
          <div className="flex items-center gap-2">
            <button 
